...
def generate_student_data_balanced(num_students):
    student_data = []
    performance_counts = {
        'A': int(num_students * 0.4),
        'B': int(num_students * 0.2),
        'C': int(num_students * 0.1),
        'D': int(num_students * 0.2),
        'E': int(num_students * 0.05),
        'F': int(num_students * 0.05)
    }
...
num_students_train = 10000
student_data_test = generate_student_data_balanced(num_students_train)
